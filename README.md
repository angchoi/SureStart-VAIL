...
Using what I learned from the Keras Tutorial and Deep Learning Guide, I worked on developing a NN model with the News Headlines Dataset For Sarcasm Detection. The link to my Kaggle Notebook is: https://www.kaggle.com/angiechoi/sarcasm-detection.
